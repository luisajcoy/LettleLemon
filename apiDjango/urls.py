...
from .views import ManageUser, ManageDelete, CategoryAdd, DeliveryUser, DeliveryDelete, MenuItemAdd, DeliveryOrderListView, DeliveryOrderUpdateView, MenuItemListView, MenuItemByCategory, CartView
